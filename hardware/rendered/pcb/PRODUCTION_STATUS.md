...
This rendered DFR0975/DFR0665 carrier package has been replaced by the
integrated Keyes E32R28T hardware. Do not send this ZIP, Gerbers, drill data,
BOM or position file to a manufacturer. The historical blockers follow only
for traceability.
